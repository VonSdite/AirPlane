(() => {
  ...
  function drawBoss(boss) {
    ...
    glow.addColorStop(0.55, `${boss.color}22`);
    glow.addColorStop(1, "transparent");
    ctx.fillStyle = glow;
    ctx.beginPath();
    ctx.arc(0, 0, boss.radius + 34, 0, PI * 2);
    ctx.fill();
    ...
    if (boss.bossKind === "hornet") {
      ...
      ctx.beginPath();
      ctx.moveTo(-88, -10);
      ctx.quadraticCurveTo(-42, -62, -8, -26);
      ctx.quadraticCurveTo(-42, 8, -94, 20);
      ctx.closePath();
      ctx.fill();
      ctx.beginPath();
      ctx.moveTo(88, -10);
      ...
      ctx.strokeStyle = "rgba(255, 238, 168, 0.85)";
      ctx.lineWidth = 4;
      ctx.beginPath();
      ctx.moveTo(-28, 8);
      ctx.lineTo(28, 8);
      ...
      ctx.beginPath();
      ctx.arc(-18, -20, 6, 0, PI * 2);
      ctx.arc(18, -20, 6, 0, PI * 2);
      ctx.fill();
      ctx.strokeStyle = "rgba(255, 210, 118, 0.92)";
      ctx.lineWidth = 3;
      ctx.beginPath();
      ctx.moveTo(-12, -44);
      ctx.lineTo(-34, -68);
      ...
      ctx.beginPath();
      ctx.moveTo(-116, 10);
      ctx.quadraticCurveTo(-96, -42, -24, -18);
      ctx.quadraticCurveTo(-78, 8, -106, 30);
      ctx.closePath();
      ctx.fill();
      ctx.beginPath();
      ctx.moveTo(116, 10);
      ...
      ctx.beginPath();
      ctx.moveTo(0, -38);
      ctx.quadraticCurveTo(88, -44, 116, 12);
      ctx.lineTo(52, 24);
      ctx.lineTo(12, 14);
      ctx.lineTo(0, 44);
      ctx.lineTo(-12, 14);
      ctx.lineTo(-52, 24);
      ctx.lineTo(-116, 12);
      ctx.quadraticCurveTo(-88, -44, 0, -38);
      ctx.closePath();
      ctx.fill();

      ctx.fillStyle = "rgba(10, 28, 46, 0.68)";
      ctx.beginPath();
      ctx.moveTo(0, -24);
      ctx.lineTo(12, 14);
      ctx.lineTo(0, 30);
      ...
      ctx.strokeStyle = "rgba(210, 248, 255, 0.88)";
      ctx.lineWidth = 3;
      ctx.beginPath();
      ctx.moveTo(-76, 2);
      ctx.quadraticCurveTo(0, -24, 76, 2);
      ctx.moveTo(-48, 18);
      ctx.quadraticCurveTo(0, 2, 48, 18);
      ctx.stroke();

      ctx.strokeStyle = "rgba(146, 228, 255, 0.8)";
      ctx.lineWidth = 2;
      ctx.beginPath();
      ctx.moveTo(-22, 22);
      ctx.lineTo(-34, 58);
      ...
      ctx.lineWidth = 4;
      ctx.beginPath();
      ctx.arc(0, 0, 72 + Math.sin(boss.age * 4) * 5, 0, PI * 2);
      ctx.stroke();

      ctx.rotate(boss.age * 0.55);
      for (let i = 0; i < 6; i += 1) {
        ctx.save();
        ctx.rotate((PI * 2 * i) / 6);
        ctx.fillStyle = boss.color;
      ...
      ctx.fillStyle = boss.color;
      ctx.beginPath();
      ctx.arc(0, 0, 46, 0, PI * 2);
      ctx.fill();
      ctx.fillStyle = "rgba(255,255,255,0.26)";
      ctx.beginPath();
      ctx.arc(0, 0, 20 + pulse * 3, 0, PI * 2);
      ctx.fill();
      ctx.strokeStyle = "rgba(235, 220, 255, 0.74)";
      ctx.lineWidth = 3;
      ctx.beginPath();
      ctx.moveTo(-58, 0);
      ctx.lineTo(58, 0);
      ...
      ctx.fillStyle = "rgba(18, 49, 42, 0.78)";
      ctx.beginPath();
      ctx.roundRect(-58, -18, 116, 36, 12);
      ctx.fill();
      ctx.fillStyle = "rgba(235,255,240,0.16)";
      ctx.fillRect(-52, -12, 104, 8);
      ctx.fillRect(-52, 4, 104, 8);

      ctx.strokeStyle = "rgba(218, 255, 228, 0.82)";
      ctx.lineWidth = 3;
      ctx.beginPath();
      ctx.moveTo(-86, 0);
      ctx.lineTo(86, 0);
      ...
      ctx.beginPath();
      ctx.arc(-74, -4, 8, 0, PI * 2);
      ctx.arc(74, -4, 8, 0, PI * 2);
      ctx.fill();

      ctx.strokeStyle = "rgba(178, 255, 220, 0.78)";
      ctx.lineWidth = 2;
      ctx.beginPath();
      ctx.moveTo(-92, -12);
      ctx.lineTo(-120, -30);
      ...
      ctx.lineWidth = 3;
      ctx.beginPath();
      ctx.arc(0, -66, 22 + Math.sin(boss.age * 5) * 2, 0, PI * 2);
      ctx.stroke();
      ...
      ctx.fillStyle = "rgba(51, 18, 52, 0.72)";
      ctx.beginPath();
      ctx.moveTo(0, -38);
      ctx.lineTo(12, 0);
      ctx.lineTo(0, 24);
      ...
      ctx.strokeStyle = "rgba(255, 231, 250, 0.9)";
      ctx.lineWidth = 3;
      ctx.beginPath();
      ctx.moveTo(-24, -12);
      ctx.lineTo(0, -38);
